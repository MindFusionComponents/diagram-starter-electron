...
for an Electron application. You could also use it as a playground to explore the diagramming API.

### Installation

Clone the repo
   ```sh
   git clone https://github.com/MindFusionComponents/diagram-starter-electron
   ```

## Getting Started

Run 'npm install' and then 'npm start' to start the Electron application.
